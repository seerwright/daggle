...
class RuleTemplate(Base, TimestampMixin):
    ...
    Templates define reusable rules with optional parameters.
    Examples:
    - "Teams may have a maximum of {n} members" (has_parameter=True, parameter_type='number')
    - "Participants may only belong to one team" (has_parameter=False)
    """
