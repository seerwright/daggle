...
module.exports = defineConfig({
  ...
  projects: [
    ...
    // Angular app e2e tests (port 4200 via Docker)
    {
      ...
      testMatch: /auth\.spec\.ts|e2e\.spec\.ts|profile-edit\.spec\.ts|competition-create\.spec\.ts|thumbnail-upload\.spec\.ts|competition-tabs\.spec\.ts|competition-overview\.spec\.ts|competition-data-files\.spec\.ts/,
    },
  ],
